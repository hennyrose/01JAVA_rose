...
//в подальшому можна буде додати перешкоди, зміну умов, більше королівств, варіативність посланців
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (Lannister.goldWeight > 90) {
			...
			mes2.delivery_time = Math.ceil(Lannister.distance_atr / mes1.speed);
		}

...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Thread-" + thr.getName() + "\nsum of an array: " + resultTest);
		System.out.println("speed: " + timeResultTest + " ms");
		System.out.println();
		...
		System.out.println();
		System.out.println("sum of four arrays: " + result);
		System.out.println("speed : " + timeResult + " ms");

		double timeResultDifference = timeResultTest - timeResult;
		System.out.println();
		System.out.println("speed difference: " + timeResultDifference + " ms");
	}
}
